...
func (wph *WebProductHandler) GetProcuts(w http.ResponseWriter, r *http.Request) {
	products, err := wph.ProductService.GetProcuts()
	if err != nil {
...
func (wph *WebProductHandler) GetProcut(w http.ResponseWriter, r *http.Request) {
